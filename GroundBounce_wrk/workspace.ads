<ADSWorkspace Revision="2" Version="100">
    <Workspace Name="">
        ...
        <Dataset Name="__simdata079889.ds" />
        <Dataset Name="cell_1.ds" />
        <Log Name="netlist.log" />
        <Log Name="search_history.log" />
        <Preferences Name="GroundBounce_lib_lay.prf" />
        <Preferences Name="GroundBounce_lib_sch.prf" />
        ...
        <Library Name="GroundBounce_lib" />
        <Cell Name="GroundBounce_lib:Inv" />
        <Cell Name="GroundBounce_lib:cell_1" />
        <Cell Name="Lab2_lib:INV1_v1" />
    </Workspace>
</ADSWorkspace>
